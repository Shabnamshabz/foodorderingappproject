...
class Accountpremierpage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text("ADD GIFT CARD",style: TextStyle(fontSize: 35,color: Colors.blue,fontWeight: FontWeight.bold),),
      ),
      body: Padding(
        ...
        child: Column(
          ...
          ,SizedBox(height: 22,),
            ...
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: SizedBox(width: double.infinity,child: FilledButton(onPressed: (){}, child: Text("Add Gift Cards"))),
            )
          ],
        ),
      ),
